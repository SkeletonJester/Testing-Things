...
// 正向激光
Effects.effect(pointingLaserEffect, Color.yellow,
b.data.getSourceX(),
b.data.getSourceY(),
0,
b.data
...
// -=-=-常用属性 -=-=- 
 ...
 // 爆炸伤害 
 pointingLaserBulletType.splashDamage = 50; 
 // 爆炸范围（一格 = 8 似乎，40 = 5 格） 
 ...
 pointingLaserBulletType.fragBullet = Bullets.missileSwarm
; 
 pointingLaserBulletType.fragBullets = 25; 
 // -= 炮塔 =- 
 // 发射声音 
