...
const pointingLaserSubBulletType = extend(BasicBulletType, {
    ...
    hit(b, hitx, hity) {
        ...
        Puddle.deposit(Vars.world.tileWorld(x, y), Liquids.slag, 800);
    },
...
pointingLaserSubBulletType.damage = 250;
pointingLaserSubBulletType.splashDamage = 60;
...
pointingLaserSubBulletType.hitEffect = Fx.plasticExplosion ;
pointingLaserSubBulletType.despawnEffect = Fx.plasticExplosion ;
...
/** 指向性激光炮塔 */
const pointingLaserTurret = extendContent(PowerTurret, "未来", {
    chargeTime: 60,
    cooldownDelay: 60,
...
// -= 子弹 =-
// 直接伤害
pointingLaserBulletType.damage = 700;
// 爆炸伤害
pointingLaserBulletType.splashDamage = 500;
// 爆炸范围（一格 = 8 似乎，40 = 5 格）
pointingLaserBulletType.splashDamageRadius = 60;
// 发射效果
pointingLaserBulletType.shootEffect = sql;
// 发射效果的烟？
pointingLaserBulletType.smokeEffect = Fx.shootSmallSmoke;
// 击中效果
pointingLaserBulletType.hitEffect = Fx.plasticExplosion;
// 消失效果
pointingLaserBulletType.despawnEffect = Fx.plasticExplosion;
